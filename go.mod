...
require (
	...
	github.com/lightninglabs/loop v0.27.1-beta.0.20240305140427-65b8cb603669 // indirect
...
// Need the replace rule because the resolved pseudo version of v0.17.0-beta...
// is lower than the version referenced by lndclient (v0.17.1-beta) so "go mod
// would change it back automatically.
replace github.com/lightningnetwork/lnd => github.com/lightningnetwork/lnd v0.17.0-beta.rc6.0.20240227010337-b234658945fd
